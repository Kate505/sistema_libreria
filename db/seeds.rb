...
seguridad_menu1 = Menu.create!(codigo: "MGS001", nombre: "Módulos", icono: "seguridad.png", modulo: seguridad, link_to: "/seguridad/modulos")
seguridad_menu2 = Menu.create!(codigo: "MGS002", nombre: "Menús", icono: "seguridad.png", modulo: seguridad, link_to: "/seguridad/menus")
seguridad_menu3 = Menu.create!(codigo: "MGS003", nombre: "Usuarios", icono: "seguridad.png", modulo: seguridad, link_to: "/seguridad/usuarios")
...
seguridad_menu5 = Menu.create!(codigo: "MGS005", nombre: "Roles", icono: "seguridad.png", modulo: seguridad, parent: seguridad_menu4, link_to: "/seguridad/roles")
seguridad_menu6 = Menu.create!(codigo: "MGS006", nombre: "Roles - Menús", icono: "seguridad.png", modulo: seguridad, parent: seguridad_menu4, link_to: "/seguridad/roles_menus")
seguridad_menu7 = Menu.create!(codigo: "MGS007", nombre: "Roles por Usuario", icono: "seguridad.png", modulo: seguridad, parent: seguridad_menu4, link_to: "/seguridad/roles_usuarios")
