...
empleado_admin = Empleado.create!(primer_nombre: "Administrador", primer_apellido: "Sistema", cargo: "Administrador", cedula: "0010101010001A", fecha_contratacion: Date.new(2020,1,1))
empleado_usuario = Empleado.create!(primer_nombre: "Usuario", primer_apellido: "Sistema", cargo: "Usuario", cedula: "0020202020002B", fecha_contratacion: Date.new(2020,1,1))
