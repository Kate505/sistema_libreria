module Components::ButtonHelper
  def theme_toggle(padding:, size:)
    content_tag(:label, class: "swap swap-rotate #{padding}", data: { controller: "helpers--components--theme-toggle" }) do
      safe_join([
                  tag.input(
                    type: "checkbox",
                    ...
                    value: "night",
                    data: {
                      "helpers--components--theme-toggle-target": "checkbox",
                      action: "helpers--components--theme-toggle#toggle"
                    }
                  ),
                  content_tag(:svg, xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", class: "swap-off h-#{size} w-#{size} fill-current") do
                  ...
                  content_tag(:svg, xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", class: "swap-on h-#{size} w-#{size} fill-current") do
